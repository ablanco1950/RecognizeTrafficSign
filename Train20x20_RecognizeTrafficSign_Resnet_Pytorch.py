...
train_transforms = transforms.Compose([transforms.Resize((20,20)),
...
test_transforms = transforms.Compose([transforms.Resize((20,20)),
                                      transforms.CenterCrop(20),
                                      transforms.ToTensor(),
                                      transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])

validation_transforms = transforms.Compose([transforms.Resize((20,20)),
                                            transforms.CenterCrop(20),
                                            transforms.ToTensor(),
                                            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
...
torch.save(checkpoint, 'checkpoint20x20_7epoch.pth')
