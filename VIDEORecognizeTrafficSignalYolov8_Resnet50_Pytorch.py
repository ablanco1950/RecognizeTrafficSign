        ...
        if ret != True: break
            ...
            if TabImgSelect==[]:
                ...
                for z in range(len(TabImgSelect)):
                     ...
                     cv2.putText(img, NameTrafficSignPredicted + " " + str(conf) ,text_location
                        , cv2.FONT_HERSHEY_SIMPLEX , 1
                        , text_color, 2 ,cv2.LINE_AA)
                     cv2.putText(gray1, NameTrafficSignPredicted+ " " + str(conf),text_location
                        , cv2.FONT_HERSHEY_SIMPLEX , 1
                        , text_color, 2 ,cv2.LINE_AA)            
